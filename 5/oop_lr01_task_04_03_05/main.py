...
from LoanContainer import LoanContainer
...
def test_container():
    ...
    loan1 = LoanCalculator(100000, 12, 8)
    loan2 = LoanCalculator(200000, 24, 9.5)
    container.add(loan1)
    container.add(loan2)
    ...
    container.save("loans.json")

    
    new_container = LoanContainer()
    new_container.load("loans.json")
    print("\nЗагруженные кредиты:")
    print(new_container)
